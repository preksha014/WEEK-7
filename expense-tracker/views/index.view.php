...
<main>
    <div class="container mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                ...
                <tbody>
                    <?php foreach ($groups as $group) : ?>
                        <?php if ($group['expense_id']) : ?>
                            <tr class="bg-gray-100 text-center hover:bg-gray-200 transition-all duration-300">
        ...
        <div class="mt-6 bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-all duration-300">
