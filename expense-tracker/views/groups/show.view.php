...
<main>
    ...
    $groups = [$groups]; // Convert single entry into an array
} ?>
            ...
            $("#add-group-form").submit(function (e) {
                ...
                $.ajax({
                    ...
                    error: function (response) {
                        $("#error-message").text(response.responseJSON.message).removeClass("hidden");
                        $("#success-message").addClass("hidden");
                        $("#error-name").text(response.responseJSON.errors.name);
                        $("#error-duplicate").text(response.responseJSON.errors.duplicate);
                    }
                });
            });
        })
